...
<div class="box" id="login">
    <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
        ...
        <c:if test="${not empty registeredService}">
            <c:if test="${not empty registeredService.id && ( registeredService.id == 203948234207230 || registeredService.id == 203948234207231 || registeredService.id == 203948234207232 || ( registeredService.id >= 203948234207240 && registeredService.id <= 203948234207255 ) || registeredService.id == 203948234207340 ) }">
                <hr/>
                <section class="row">
