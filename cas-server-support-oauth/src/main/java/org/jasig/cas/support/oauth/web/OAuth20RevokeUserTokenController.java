 ...
 * @since 4.1.0
 */
public final class OAuth20RevokeUserTokenController extends AbstractController {

    private static final Logger LOGGER = LoggerFactory.getLogger(OAuth20RevokeUserTokenController.class);
    ...
    /**
     * Instantiates a new o auth20 revoke user token controller.
     *
     * @param ticketRegistry the ticket registry
     * @param centralAuthenticationService the central authentication service
     * @param cipherExecutor the cipher executor
     */
    public OAuth20RevokeUserTokenController(final TicketRegistry ticketRegistry,
