...
@RunWith(Suite.class)
@Suite.SuiteClasses({OAuth20TokenAuthorizationCodeControllerTests.class, OAuth20AuthorizeControllerTests.class,
                     OAuth20AuthorizeCallbackControllerTests.class, OAuth20ProfileControllerTests.class,
